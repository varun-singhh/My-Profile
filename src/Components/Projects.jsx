...
const Projects = () => {
  return (
    <div className="flex flex-col md:w-full overflow-x-hidden overflow-y-hidden">
      <p className="uppercase font-bold text-5xl md:text-8xl -mb-36 mt-16 ml-12 text-white opacity-30 dark:text-gray-400">
        PROJECTS
      </p>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center mt-32 md:mt-10 ">
        ...
        <div data-aos="fade-left">
          <div className="flex flex-col w-64 m-3 md:m-3 items-center">
            <div className="transform transition duration-500 hover:scale-110 dark:bg-dark-gray cursor-pointer bg-white m-3 md:m-3 mt-16 md:mt-5 rounded-2xl h-80 w-full shadow-xl">
              <div className="p-10 flex justify-center">
                <img
